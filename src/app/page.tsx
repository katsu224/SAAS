      ...
      <div className="w-full max-w-md space-y-4">
        {session?.user ? (
            <div className="flex flex-col gap-4">
                <div className="p-4 bg-white dark:bg-white rounded-lg border border-zinc-200 dark:border-zinc-800 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                <Link 
                  href="/login"
                  className="flex-1 bg-white dark:bg-white hover:bg-zinc-800 dark:hover:bg-zinc-200 text-white dark:text-zinc-900 font-bold py-3 px-6 rounded-lg transition text-center shadow-lg hover:shadow-xl"
                >
                  Iniciar Sesión
                </Link>
                <Link 
                  href="/register-admin-secret"
                  className="flex-1 bg-white dark:bg-white border border-zinc-300 dark:border-zinc-700 hover:border-zinc-400 dark:hover:border-zinc-600 text-zinc-900 dark:text-white font-bold py-3 px-6 rounded-lg transition text-center"
                >
                  Crear Cuenta (Admin)
                </Link>
            </div>
