...
export default async function Header() {
    ...
    return (
        <header className="flex items-center justify-end px-6 py-4 bg-white dark:bg-zinc-950 border-b border-zinc-200 dark:border-zinc-800" suppressHydrationWarning>
